...
export default function ProfilePage() {
  ...
  const handleResendVerificationCode = async () => {
    ...
    try {
      ...
      toast.success('Verification code resent to new email address');
                      ...
                      <form onSubmit={handleSave} className="space-y-6">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          ...
                          <motion.div
                            ...
                            className="space-y-2"
                          >
                            <label className="block text-gray-700 font-medium text-sm">Current Email Address</label>
                            <div className="relative">
                          ...
                          {!pendingEmailChange ? (
                            ...
                            <div className="space-y-6">
                              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div className="space-y-2">
                                  <label className="block text-gray-700 font-medium text-sm">Confirm New Email</label>
                                  <div className="relative">
                                    <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-gray-400" size={18} />
                                    <Input 
                                      type="email"
