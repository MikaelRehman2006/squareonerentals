...
export function ListingFilters({ onFilterChange }: ListingFiltersProps) {
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg sticky top-4 max-h-[calc(100vh-2rem)] overflow-y-auto w-full">
      <h3 className="text-xl font-semibold mb-6 border-b pb-3">Filters</h3>
      ...
      <div className="mb-6">
        ...
        <div className="grid grid-cols-2 gap-3">
          <input
            ...
            className="w-full px-3 py-2 border rounded-md text-black focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
